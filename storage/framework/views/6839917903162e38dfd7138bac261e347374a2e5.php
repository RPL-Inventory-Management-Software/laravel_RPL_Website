...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset ('css/inventory_equipment.css')); ?>">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 center">
                <img src="<?php echo e(asset('img/item.jpg')); ?>" class="item-photo">
            </div>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="item-description-container">
                    ...
                    <div class="d-flex flex-row bd-highlight ">
                        <div class="p-2 bd-highlight"><img class="profile-picture" src="<?php echo e(asset('img/dummy-profile.png')); ?>"></div>
...
</html><?php /**PATH C:\Users\Asus\Documents\GitHub\laravel_RPL_Website\resources\views/inventory_equipment.blade.php ENDPATH**/ ?>